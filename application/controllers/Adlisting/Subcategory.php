...
class Subcategory extends MY_Controller {
    ...
    public function __construct(){
           ...
           parent::__construct();
           $this->load->model('Adlisting/subcategorymodel');
    ...
    public function index($cat){
            ...
            unset($_SESSION['sort']);
            $search_query = "";
            $data['ads']     =  $this->subcategorymodel->all_classified($cat,$search_query,10,0);
            ...
            $this->load->view('pages/subcategory.php');
    ...
    public function load_more_ajax($cat){
         ...
         $limit = 10;
         $offset = $data*10;
         $ads = $this->subcategorymodel->all_classified($cat,$search_string,$limit,$offset);  ?>
      <?php  if(count($ads)): ?>
